...
(function() {
  ...
  MWSClient = (function(_super) {
    ...
    function MWSClient() {
      var e, extras, k, options, v, _i, _len, _ref, _ref1, _ref10, _ref11, _ref12, _ref13, _ref14, _ref15, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9;
      ...
      if ((_ref11 = this.marketplaceId) == null) {
      ...
      req = https.request(options, function(res) {
        ...
        res.on('end', function() {
          ...
          return mwsres.parseBody(function(err, parsed) {
            var invokeOpts, nextRequest, _ref12, _ref13, _ref14;
            if ((options.nextTokenCall != null) && (((_ref12 = mwsres.result) != null ? (_ref13 = _ref12.NextToken) != null ? _ref13.length : void 0 : void 0) > 0)) {
              invokeOpts = {
              ...
              if (options.nextTokenCallUseHasNext) {
                ...
                if (((_ref14 = mwsres.result) != null ? _ref14.HasNext : void 0) === 'true') {
              ...
              mwsres.getNext = function() {
                return _this.invoke(nextRequest, invokeOpts, cb);
              };
            }
  ...
  MWSResponse = (function() {
    ...
    MWSResponse.prototype.parseBody = function(cb) {
      var body, isXml, md5, parser, _ref, _ref1,
        _this = this;
      isXml = this.headers['content-type'] === 'text/xml';
      isXml = isXml || (this.headers['content-type'] === 'text/plain' && this.body.indexOf('<?xml') === 0);
      if (isXml) {
        ...
        if (this.headers['content-md5'] === md5) {
          ...
          console.log("Invalid MD5 on received content: amazon=" + this.headers['content-md5'] + " , calculated=" + md5);
          this.response = null;
          return cb("Invalid MD5 on received content: amazon=" + this.headers['content-md5'] + " , calculated=" + md5, null);
        }
      } else {
        this.response = null;
