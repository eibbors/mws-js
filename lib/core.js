...
var EventEmitter, MWSBool, MWSClient, MWSComplexList, MWSComplexParam, MWSEnum, MWSEnumList, MWSParam, MWSParamList, MWSRequest, MWSResponse, MWSService, MWSTimestamp, MWS_LOCALES, MWS_SIGNATURE_METHOD, MWS_SIGNATURE_VERSION, crypto, https, qs, types, xml2js,
...
MWSClient = (function(_super) {
  ...
  function MWSClient() {
    var e, extras, k, options, v, _i, _len, _ref, _ref1, _ref10, _ref11, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9;
    ...
    if (options.locale != null) {
      this.host = (_ref = (_ref1 = options.host) != null ? _ref1 : options.locale.host) != null ? _ref : "mws.amazonservices.com";
      this.marketplaceId = options.locale.marketplaceId;
      this.country = (_ref2 = options.locale.country) != null ? _ref2 : void 0;
      this.domain = (_ref3 = options.locale.domain) != null ? _ref3 : void 0;
    }
    this.host = (_ref4 = options.host) != null ? _ref4 : "mws.amazonservices.com";
    this.port = (_ref5 = options.port) != null ? _ref5 : 443;
    this.merchantId = (_ref6 = options.merchantId) != null ? _ref6 : null;
    this.accessKeyId = (_ref7 = options.accessKeyId) != null ? _ref7 : null;
    this.secretAccessKey = (_ref8 = options.secretAccessKey) != null ? _ref8 : null;
    this.marketplaceId = (_ref9 = options.marketplaceId) != null ? _ref9 : null;
    ...
    this.appHost = (_ref10 = options.appHost) != null ? _ref10 : void 0;
    this.appPlatform = (_ref11 = options.appPlatform) != null ? _ref11 : void 0;
    options;

  }

  MWSClient.prototype.sign = function(service, q) {
    var hash, k, keys, path, sorted, stringToSign, v, _i, _len, _ref, _ref1;
    if (q == null) {
      q = {};
    }
    ...
    if ((_ref1 = q['AWSAccessKeyId']) == null) {
  ...
  MWSClient.prototype.invoke = function(request, options, cb) {
    var agentParams, h, q, req, v, _ref, _ref1, _ref10, _ref11, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9,
      _this = this;
    if ((_ref = options.path) == null) {
      options.path = (_ref1 = (_ref2 = request.service) != null ? _ref2.path : void 0) != null ? _ref1 : '/';
    }
    q = this.sign((_ref3 = (_ref4 = options.service) != null ? _ref4 : request.service) != null ? _ref3 : null, request.query((_ref5 = options.query) != null ? _ref5 : {}));
    if ((_ref6 = options.headers) == null) {
      options.headers = {};
    }
    _ref7 = request.headers;
    for (h in _ref7) {
      v = _ref7[h];
      options.headers[h] = v;
    }
    if (request.body || options.body) {
      if ((_ref8 = options.body) == null) {
    ...
    if ((_ref9 = options.host) == null) {
      options.host = this.host;
    }
    if ((_ref10 = options.port) == null) {
      options.port = this.port;
    }
    if ((_ref11 = options.method) == null) {
      options.method = 'POST';
    }
    req = https.request(options, function(res) {
      ...
      res.on('end', function() {
        ...
        return mwsres.parseBody(function(err, parsed) {
          var nextRequest, _ref12;
          if ((options.nextTokenCall != null) && (((_ref12 = mwsres.result) != null ? _ref12.NextToken : void 0) != null)) {
            mwsres.nextToken = mwsres.result.NextToken;
            nextRequest = new options.nextTokenCall({
              NextToken: mwsres.nextToken
            });
            mwsres.getNext = function(callback) {
              return _this.invoke(nextRequest, {}, callback);
            };
          }
...
MWSService = (function() {
  ...
  function MWSService(options) {
    ...
    if ((_ref1 = this.path) == null) {
      this.path = '/';
    }
    if ((_ref2 = this.version) == null) {
      this.version = '2009-01-01';
    }
    if ((_ref3 = this.legacy) == null) {
      this.legacy = false;
    }
  }
...
MWSRequest = (function() {
  ...
  function MWSRequest(service, action, params, headers, body, init) {
    var i, p, pid, _ref, _ref1, _ref2, _ref3;
    ...
    if ((_ref = this.service) == null) {
      this.service = new MWSService;
    }
    _ref1 = this.params;
    for (i in _ref1) {
      p = _ref1[i];
      pid = (_ref2 = p.name) != null ? _ref2 : i;
      if (init[pid]) {
        p.set(init[pid]);
      }
      this[pid] = (_ref3 = this.params[i]) != null ? _ref3 : null;
    }
  }
  ...
  MWSRequest.prototype.attach = function(body, format) {
    ...
    this.headers['content-md5'] = crypto.createHash('md5').update(body).digest("base64");
...
MWSResponse = (function() {
  ...
  MWSResponse.prototype.parseHeaders = function() {
    var header, id, ns, value, xreg, _base, _ref, _ref1, _results;
    _ref = this.headers;
    _results = [];
    for (header in _ref) {
      value = _ref[header];
      ...
      if (xreg) {
        ...
        if ((_ref1 = (_base = this.meta)[ns]) == null) {
          _base[ns] = {};
        }
  ...
  MWSResponse.prototype.parseBody = function(cb) {
    ...
    if (this.headers['content-type'] === 'text/xml') {
      ...
      this.response = null;
      return cb("Unrecognized content format: " + ((_ref = this.headers['content-type']) != null ? _ref : 'undefined'), null);
    }
  };
