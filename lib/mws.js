...
var orders = exports.orders = require('./orders'),
	sellers = exports.sellers = require('./sellers'),
	fba = exports.fba = require('./fba'),
	feeds = exports.feeds = required('./feeds'),
	products = exports.products = required('./products');
	reports = exports.reports = required('./reports');
